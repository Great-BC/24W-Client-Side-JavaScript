...
function updateBatteryStatus(battery) {
    ...
    //Lab 5 Code
    chargeImage.setAttribute("src", `https://robohash.org/${battery.level * 100}.png`)

    
}
// Lab 5 code
    document.getElementById("battery").appendChild(chargeImage);
